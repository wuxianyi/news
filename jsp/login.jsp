...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <link rel="stylesheet" href="<%=request.getContextPath() %>/resource/login/css/supersized.css">
    ...
    <body oncontextmenu="return false">
        ...
        <script src="<%=request.getContextPath() %>/resource/login/js/supersized-init.js"></script>
		<script>
		$(".btn").click(function(){
			is_hide();
		})
