...
<input type="text" name="name" datatype="s2-30"/>
<span class="required">*</span>
</div>
<div class="text_info clearfix"><span>用户名：</span></div>
<div class="input_info">
<input type="text" name="username" datatype="s3-16" ajaxurl="checkUsername"/>
<span class="required">*</span>
</div>
<div class="text_info clearfix"><span>密码：</span></div>
<div class="input_info">
<input type="password" name="password" datatype="s3-16"/>
<span class="required">*</span>
</div>
<div class="text_info clearfix"><span>重复密码：</span></div>
<div class="input_info">
<input type="password" recheck="password" datatype="*"/>
<span class="required">*</span>
</div>
<div class="text_info clearfix"><span>出生日期：</span></div>
<div class="input_info">
<input type="date" name="birthday" datatype="*" class="width200"/>
<span class="required">*</span>
</div>
<div class="text_info clearfix"><span>入职时间：</span></div>
<div class="input_info">
<input type="date" name="startDate" datatype="*" class="width200"/>
<span class="required">*</span>
</div>
