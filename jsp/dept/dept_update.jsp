...
<div id="main">
<form action="../dept" method="post" class="main_form">
<input type="hidden" name="_method" value="put"/>
<input type="hidden" name="id" value="${dept.id}"/>
<div class="text_info clearfix"><span>部门名称：</span></div>
<div class="input_info">
<input type="text" name="name" value="${dept.name }" datatype="s2-30,name"/>
<span class="required">*</span>
</div>

<div class="button_info clearfix">
<input type="submit" value="保存" class="btn_save"/>
<input type="button" value="取消" class="btn_save" onclick="location.href='../depts'"/>
</div>
</form>
</div>
